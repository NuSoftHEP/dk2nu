...
// Wed Nov  7 00:06:00 2012 by ROOT version 5.33/03
// from TTree g4minerva/g4numi Neutrino ntuple
// found on file: generic_g4minerva.root
//////////////////////////////////////////////////////////
...
#ifdef g4minerva_cxx
g4minerva::g4minerva(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("generic_g4minerva.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("generic_g4minerva.root");
      }
      f->GetObject("g4minerva",tree);
...
Int_t g4minerva::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t g4minerva::LoadTree(Long64_t entry)
{
...
void g4minerva::Init(TTree *tree)
{
...
void g4minerva::Show(Long64_t entry)
{
...
Int_t g4minerva::Cut(Long64_t /* entry */)
{
